    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
            <g clipPath="url(#clip0_1_1191)">
                ...
                <path d="M21.7622 10.4415L18.6091 8.67725L14.7867 12.4996L18.6093 16.3222L21.7627 14.5578C22.5182 14.1345 22.9692 13.3652 22.9692 12.4996C22.9692 11.634 22.5182 10.8648 21.7622 10.4415Z" fill="white" />
